...
CF_data_path <- file.path(base_dir, "Data", "HRV_ConfoundingFactors_Sample.xlsx")
...
HRV_MADRS$Age <- RD_CF$Age[match(HRV_MADRS$Subject_number, CF$Subject_number)]
HRV_MADRS$Sex <- RD_CF$Sex[match(HRV_MADRS$Subject_number, CF$Subject_number)]
HRV_MADRS$BMI <- RD_CF$BMI[match(HRV_MADRS$Subject_number, CF$Subject_number)]
