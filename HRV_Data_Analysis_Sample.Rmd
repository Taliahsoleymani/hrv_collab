...
### 3.. Correlation Between Change in Mood Rating and HR Level at the End of Infusion
```{r}
library(ggplot2)
library(dplyr)
...
Model_mood <- subset(HRV_MADRS_recoded, Timepoint == "Infusion_During", select = c("Subject_number", "Drug", "Infusion", "Session_date", "MADRS_Total"))
head(Model_mood)
